...
urlpatterns = [
    ...
    path('administracion/eliminar_actor/<int:id>', views.eliminar_actor, name='eliminar_actor'),
    path('administracion/editar_actor/<int:id>', views.editar_actor, name='editar_actor'),
    path('unir_actor_pelicula/<int:id>', views.unir_actor_pelicula),
    path('administracion/eliminar_personaje/<int:id>', views.eliminar_personaje_pelicula, name='eliminar_personaje'),
    path('unir_actor_serie/<int:id>', views.unir_actor_serie),
    path('administracion/eliminar_personaje_serie/<int:id>', views.eliminar_personaje_serie, name='eliminar_personaje_serie'),
